...
Live today: **C2** ships its two originals; **C4** (the warehouse) ships its two
originals plus the canonical cross-challenge "document" hint. **C1** and **C3**
ship no hints. Everything below is a proposal.

---

## Challenge 1 — Steganography lvl 1 (base 100) — *currently no live hints*
...
## Challenge 2 — Steganography lvl 2 (base 200) — *live: the two originals*
...
## Challenge 3 — Steganography lvl 3 (base 500) — *currently no live hints*
